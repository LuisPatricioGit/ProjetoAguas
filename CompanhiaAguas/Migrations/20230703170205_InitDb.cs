    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsumptionTables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TierValue = table.Column<int>(type: "int", nullable: false),
                    ...
                    ConsumptionTableId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tiers_ConsumptionTables_ConsumptionTableId",
                        column: x => x.ConsumptionTableId,
                        principalTable: "ConsumptionTables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tiers_ContractTypes_ContractTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplyPoints_Meters_MeterId",
                        column: x => x.MeterId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplyPointId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contracts_SupplyPoints_SupplyPointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_SupplyPointId",
                table: "Contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplyPoints_MeterId",
                table: "SupplyPoints",
                column: "MeterId");

            migrationBuilder.CreateIndex(
                name: "IX_Tiers_ConsumptionTableId",
                table: "Tiers",
                column: "ConsumptionTableId");

            migrationBuilder.CreateIndex(
                name: "IX_Tiers_ContractTypeId",
                table: "Tiers",
                column: "ContractTypeId");
        }
